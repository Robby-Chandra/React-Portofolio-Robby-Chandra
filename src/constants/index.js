export const HERO_CONTENT =
  "Mobile and web developer with a passion for creating intuitive, user-friendly applications. Currently a student at Bina Nusantara University, I'm eager to apply my skills in various programming languages and frameworks to real-world projects. Let's build something amazing together!";
...
export const PROJECT = [
  {
    ...
    image: willify,
    description:
      "Willify is a Music Player website project that I developed using HTML, CSS, and JavaScript. This website has functionality similar to popular music platforms like Spotify, SoundCloud etc.",
...

  {
    ...
    image: VirtualFR,
    description:
      "Virtual Fitting Room is an application I developed using Unity with Augmented Reality features. This app allows users to try on clothes from offline stores online, eliminating the need to visit physical stores.",
    language: ["C#", "Unity"],
  },

  {
    ...
    image: PurePlate,
    description:
      "A Marketplace application for healthy food. Developed using Kotlin with functionality similar to Shopee, Tokopedia, etc.",
    language: ["Kotlin"],
  },

  {
    ...
    image: BonkGarage,
    description:
      "A Marketplace application for die-cast toys like Hot Wheels, Mini GT, etc. Developed using Kotlin.",
    language: ["Kotlin"],
  },

  {
    ...
    image: DokDok,
    description:
      "HealthEase is an innovative health care application inspired by platforms like Halodoc, reimagined with a fresh user interface and enhanced features. Designed using Figma, this app aims to provide users with a seamless and comprehensive digital healthcare experience.",
    language: ["Figma"],
  },

  {
    ...
    image: Portofolio1,
    description:
      "This project is a personal portfolio website designed and developed to showcase my skills, projects, and professional experience in web development. The website serves as a digital resume and a demonstration of my capabilities in front-end technologies.",
...

  {
    ...
    image: BonkToys,
    description:
      "Bonk Toys is a dynamic mobile application designed for action figure enthusiasts, collectors, and sellers. Built with Kotlin, this user-friendly platform creates a vibrant community where users can buy, sell, and trade action figures with ease.",
    language: ["Flutter"],
  },
];

export const CONTACT = {
  address: "Koja, Jakarta Utara",
